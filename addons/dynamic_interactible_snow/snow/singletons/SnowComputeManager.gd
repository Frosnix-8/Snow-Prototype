...
func _compile_shader() -> void:
	var shader_file: RDShaderFile = load("res://addons/dynamic_interactible_snow/snow/compute/snow-stamp.glsl")
	var spirv: RDShaderSPIRV = shader_file.get_spirv()
	shader = rd.shader_create_from_spirv(spirv)
	pipeline = rd.compute_pipeline_create(shader)
	
func _compile_smoothing_shader() -> void:
	var shader_file: RDShaderFile = load("res://addons/dynamic_interactible_snow/snow/compute/snow-stamp-smooth.glsl")
	var spirv: RDShaderSPIRV = shader_file.get_spirv()
...
func _compile_mipmap_shader() -> void:
	var shader_file : RDShaderFile = load("res://addons/dynamic_interactible_snow/snow/compute/snow-mipmap.glsl")
	var spirv : RDShaderSPIRV = shader_file.get_spirv()
...
func _compile_noise_shader() -> void:
	var shader_file: RDShaderFile = load("res://addons/dynamic_interactible_snow/snow/compute/snow-noise-generation.glsl")
	var spirv: RDShaderSPIRV = shader_file.get_spirv()
...
func _compile_ambient_shader() -> void:
	var shader_file: RDShaderFile = load("res://addons/dynamic_interactible_snow/snow/compute/snow-noise-accumulate.glsl")
	var spirv: RDShaderSPIRV = shader_file.get_spirv()
...
func _create_atlas(initial_value: float = 0.0) -> void:
	...
	initial_data.resize(ATLAS_RESOLUTION * ATLAS_RESOLUTION * 4) # 4 bytes/pixel, float
