...
static var snow_mesh_material : ShaderMaterial = preload("res://addons/dynamic_interactible_snow/snow/snow meshes/snow-shader-material.tres")

var mesh_high : PlaneMesh = preload("res://addons/dynamic_interactible_snow/snow/snow meshes/high-quality-plane.tres")
var mesh_med :  PlaneMesh = preload("res://addons/dynamic_interactible_snow/snow/snow meshes/medium-quality-mesh.tres")
var mesh_low :PlaneMesh = preload("res://addons/dynamic_interactible_snow/snow/snow meshes/low-quality-mesh.tres")
var mesh_lowst :  PlaneMesh = preload("res://addons/dynamic_interactible_snow/snow/snow meshes/lowest-quality-mesh.tres")
var mesh_lowsp : PlaneMesh = preload("res://addons/dynamic_interactible_snow/snow/snow meshes/lowestest-quality-mesh.tres")
var mesh_lowmx : PlaneMesh = preload("res://addons/dynamic_interactible_snow/snow/snow meshes/lowestestest-quality-mesh.tres")


#@onready var snow_curve : CurveTexture = preload("res://snow/snow-compresion-curve-tex.tres")
@onready var snow_tile : PackedScene = preload("res://addons/dynamic_interactible_snow/snow/scenes/snow-texture-redux.tscn")
