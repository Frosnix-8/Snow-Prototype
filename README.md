...
for an fps game revolving around snow mechanics both visually and physically.
...
on the CPU side, this system uses workerthreads to calculate CPU-side arrays for collisions and more. up to 256 64x64 grids is heavy!
in practice, a single tile only needs about 2 ms of work to completely do all the CPU black magic I coded. It's just some deformation and
...
-pretty good performance right now
